  ...
  React.useEffect(() => {
    const handleWheel = (event) => {
      ...
      setScrollY((prev) => {
        ...
        // אם הגלילה הגיעה למינימום (0) וגוללים למעלה, התחל מעבר לעמוד ששת הימים
        if (newValue <= 0 && event.deltaY < 0) {
          navigate("/sixday");
          return 0;
        }
        
        // אם הגלילה הגיעה למקסימום (300) וגוללים למטה, התחל מעבר לעמוד יום הכיפורים
